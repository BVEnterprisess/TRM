...
echo -e "   bash scripts/cloud_train.sh"
echo -e "   STAGE=smoke bash scripts/cloud_train.sh"
echo -e "   cargo run --release --features candle-cuda --bin train -- --preset 7m --print-params"
echo -e "\033[1;36m=======================================================\n\033[0m"
